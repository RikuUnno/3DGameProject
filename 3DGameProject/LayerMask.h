...
struct mask
{
	static const int ALL = layerMask::DEFAULT | layerMask::PLAYER | layerMask::ENEMY | layerMask::ENVIRONMENT | layerMask::TRIGGER | layerMask::GROUND;	// 全レイヤー
	static const int PLAYER = layerMask::ENEMY | layerMask::ENVIRONMENT | layerMask::TRIGGER | layerMask::GROUND;										// プレイヤーが当たるレイヤー
	static const int ENEMY = layerMask::PLAYER | layerMask::ENVIRONMENT | layerMask::TRIGGER | layerMask::GROUND;										// エネミーが当たるレイヤー
	...
	static const int GROUND = layerMask::PLAYER | layerMask::ENEMY;																// 地面が当たるレイヤー
	// etc...
};